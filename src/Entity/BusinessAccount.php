...
class BusinessAccount
{
    ...
    #[ORM\OneToMany(mappedBy: 'businessAccount', targetEntity: BusinessAccountTemp::class)]
    private Collection $businessAccountTemps;

    public function __construct()
    {
        $this->businessAccountTemps = new ArrayCollection();
    }
    ...
    /**
     * @return Collection<int, BusinessAccountTemp>
     */
    public function getBusinessAccountTemps(): Collection
    {
        return $this->businessAccountTemps;
    }

    public function addBusinessAccountTemp(BusinessAccountTemp $businessAccountTemp): static
    {
        if (!$this->businessAccountTemps->contains($businessAccountTemp)) {
            $this->businessAccountTemps->add($businessAccountTemp);
            $businessAccountTemp->setBusinessAccount($this);
        }

        return $this;
    }

    public function removeBusinessAccountTemp(BusinessAccountTemp $businessAccountTemp): static
    {
        if ($this->businessAccountTemps->removeElement($businessAccountTemp)) {
            // set the owning side to null (unless already changed)
            if ($businessAccountTemp->getBusinessAccount() === $this) {
                $businessAccountTemp->setBusinessAccount(null);
            }
        }
