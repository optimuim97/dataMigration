...
#[UniqueEntity('numero', message: 'Ce compte existe déjà. Veuillez utiliser une autre adresse email ou vous connecter.')]
class Account
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'Account', targetEntity: AccountTemp::class)]
    private Collection $accountTemps;
    ...
    {
        $this->accountTemps = new ArrayCollection();
    }
    ...
    /**
     * @return Collection<int, AccountTemp>
     */
    public function getAccountTemps(): Collection
    {
        return $this->accountTemps;
    }

    public function addAccountTemp(AccountTemp $accountTemp): static
    {
        if (!$this->accountTemps->contains($accountTemp)) {
            $this->accountTemps->add($accountTemp);
            $accountTemp->setAccount($this);
        }

        return $this;
    }

    public function removeAccountTemp(AccountTemp $accountTemp): static
    {
        if ($this->accountTemps->removeElement($accountTemp)) {
            // set the owning side to null (unless already changed)
            if ($accountTemp->getAccount() === $this) {
